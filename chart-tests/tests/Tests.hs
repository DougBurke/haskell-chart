...
allTests =
     ...
     , ("polarcfaa", stdSize, const $ simple $ TestPolar.cfaChart True True False)
     , ("polarcfab", stdSize, const $ simple $ TestPolar.cfaChart True False False)
     , ("polarcfac", stdSizeV, const $ simple $ TestPolar.cfaChart False True True)
     , ("polarcfad", stdSize, const $ simple $ TestPolar.cfaChart False False True)
     , ("polarcfae", stdSize, const $ simple $ TestPolar.cfaBChart True True False)
     , ("polarcfaf", stdSizeV, const $ simple $ TestPolar.cfaBChart True False True)
     , ("polarcfag", stdSize, const $ simple $ TestPolar.cfaBChart False True True)
     , ("polarcfah", stdSize, const $ simple $ TestPolar.cfaBChart False False True)
